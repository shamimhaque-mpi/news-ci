<?php 
    ...
    */
	...
	function set_msg($type=null, $title=null, $msg=null,$btn=true, $name="msg"){
	    ...
	    switch ($type) {
	        case 'success':
	            $niddle = "<script>toastr.success(`$title`)</script>";
	            break;

	        case 'warning':
	            $niddle = "<script>toastr.warning(`$title`)</script>";
	            break;

	        case 'danger':
	            $niddle = "<script>toastr.error(`$title`)</script>";
	            break;
	    }

	    

	    $ci->session->set_flashdata($name, $niddle);
	}
