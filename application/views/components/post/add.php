                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-lg-9 col-lg-offset-1">
                            <div class="row">
                                <label class="col-sm-3 control-label">News Title <span class="req">*</span></label>
                                <div class="col-sm-9 form-group">
                                    <input type="text" name="title"  class="form-control" required>
                                </div>
                            </div>
                            <div class="row">
                                <label class="col-sm-3 control-label">Select Menu <span class="req">*</span></label>
                                <div class="col-sm-9 form-group">
                            ...
                            <div class="row">
                                <label class="col-sm-3 control-label">Select Sub Menu</label>
                                <div class="col-sm-9 form-group">
                                    <div id="submenu">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 form-group">
                                    <textarea  name="description" rows="10" placeholder="Enter Description..." class="form-control" required></textarea>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 form-group">
                                    <label class="control-label"><input type="checkbox" name="is_latest" value="1">This Latest News?</label>
                                    <label class="control-label"><input type="checkbox" name="is_feature" value="1">Feature</label>
                                    <label class="control-label"><input type="checkbox" name="is_publish" value="1">Publish</label>
                                </div>
