<style>
    ...
    .panel-default .panel-title {cursor: pointer;}
    ...
    .switch > input[type='checkbox']:checked + span::before {background: #00c4ff;}
    .switch > input[type='checkbox']:checked + span::after {left: calc(100% - 1.125rem);}
    .switch.x1 > span {transform: scale(1.1);}
    .switch.x2 > span {transform: scale(1.2);}
    .switch.x3 > span {transform: scale(1.3);}
    .switch.x4 > span {transform: scale(1.4);}
    .switch.x5 > span {transform: scale(1.5);}
    .switch.x6 > span {transform: scale(1.6);}
</style>
