    ...
    <div class="row">
        <nav class="col-xs-12 content-fixed-nav">
            <ul>
                ...
                <?php
                    $messages = read('message', ['status'=>'unseen', 'id DESC']);
                ?>
                <li class="dropdown">
                    <a id="message-menu" data-toggle="dropdown" style="border-left: none;">
                        <i class="fa fa-envelope-o"></i>
                        <span class="badge badge-messages"><?php echo $messages ? count($messages) : 0; ?></span>
                    ...
                    <ul class="dropdown-menu dropdown-menu-left" aria-labelledby="message-menu">
                        ...
                        ?>
                            <li><a href="<?php echo base_url('message/message/m_view/'.$value->id.'?system_id=MzU=')?>" title=""><?=($value->name)?></a></li>
                        <?php } ?>
                        <li class="divider"></li>
                        <li><a href="<?php echo site_url('message/message/index?system_id=MzU='); ?>">All</a></li>
                    </ul>
                </li>
