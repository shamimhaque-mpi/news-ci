<?php class Setting extends Admin_Controller{
        ...
        public function add_header(){
            ...
            $types = array('jpg','JPG','svg','png','PNG','gif','GIF');
        ...
        public function add_footer(){
            $data = [
                ...
                'editor_name'   => str_case_secure($this->input->post('editor_name')),
                'editor_mobile'   => str_case_secure($this->input->post('editor_mobile')),
                'publisher_name'   => str_case_secure($this->input->post('publisher_name')),
                'publisher_mobile'   => str_case_secure($this->input->post('publisher_mobile')),
            ];
