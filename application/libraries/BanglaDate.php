...
class BanglaDate {
     ...
     * @param type $hour
     */
    function BanglaDate( $timestamp, $hour) {
    ...
    function set_time( $timestamp, $hour = 6 ) {
       echo  $this->BanglaDate( $timestamp, $hour );
    }
    /**
    ...
    function bangla_number( $int ) {
     ...
     /*
     * Convert the English Month  text to Bangla Month text      
     */
    function bangla_month($month = null) {
        $months = array( 
            '01' => 'জানুয়ারী', 
            '02' => 'ফেব্রুয়ারী', 
            '03' => 'মার্চ', 
